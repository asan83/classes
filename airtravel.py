...
class Flight:
    ...
    def __init__(self, number, aircraft):
        ...
        # "[None] + " appends a single null element at the start of the list because list is zero based
        # _ in rows discards the row number
    ...
    def _parse_seat(self, seat):
        ...
        row_text = seat[:-1]  # take all but the last character
        try:
            row = int(row_text)
        except ValueError:
